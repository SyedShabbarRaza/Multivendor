...
function ShoppingCart({ setOpenCart }) {
  const cartData = [
    {
      name: "Iphone 14 pro max 256Gb ssd and 8GB ram silver colourIphone 14 pro max 256Gb ssd and 8GB ram silver colour",
      description: "test",
      price: 1020,
    },
    {
    ...
    <div className="border-b p-4">
      <div className="w-full flex items-center">
        ...
        <div className="pl-[5px] md:pl-[10px] w-full">
            ...
            <h4 className="font-[600px] text-[17px] pt-[3px] text-[#d02222] font-sans">{data.price*value}</h4>
        </div>
        <RxCross1
        className="cursor-pointer"
        />
